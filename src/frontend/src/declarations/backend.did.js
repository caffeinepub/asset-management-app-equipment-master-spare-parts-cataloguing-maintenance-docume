...
export const idlService = IDL.Service({
  ...
  'createEquipment' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text, Time, Time],
      [IDL.Nat],
      [],
    ),
  ...
  'updateEquipment' : IDL.Func(
      [IDL.Nat, IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text, Time, Time],
      [IDL.Bool],
      [],
    ),
  ...
  'updateSparePart' : IDL.Func(
      [IDL.Nat, IDL.Nat, IDL.Text, IDL.Text, IDL.Nat, IDL.Text],
      [IDL.Bool],
      [],
    ),
